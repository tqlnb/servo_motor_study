...
## 
## Makefile     : control.mk
## Generated on : Thu Oct 10 17:04:02 2024
...
SRCS = $(START_DIR)/control_ert_rtw/control.c $(START_DIR)/control_ert_rtw/control_data.c
...
OBJS = control.obj control_data.obj
...
%.obj : $(START_DIR)/control_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
control_data.obj : $(START_DIR)/control_ert_rtw/control_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
