...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    GPIO_InitStruct.Pin = M1_TEMPERATURE_Pin|M1_CURR_AMPL_W_Pin|M1_BUS_VOLTAGE_Pin|M1_CURR_AMPL_V_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOA, M1_TEMPERATURE_Pin|M1_CURR_AMPL_W_Pin|M1_BUS_VOLTAGE_Pin|M1_CURR_AMPL_V_Pin);
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    */
    HAL_GPIO_DeInit(GPIOE, M1_PWM_UL_Pin|M1_PWM_UH_Pin|M1_PWM_VL_Pin|M1_PWM_VH_Pin
                          |M1_PWM_WL_Pin|M1_PWM_WH_Pin|M1_OCP_Pin);
